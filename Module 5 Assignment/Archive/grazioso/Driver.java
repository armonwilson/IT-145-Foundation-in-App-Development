...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        // Operating Loop, breaks on user input "q". User input calls appropriate method
        String i;
        while (i != "q") {
        	displayMenu();
        	i = scnr.next();
        	...
        	if (i.equals("4")) {
        		//TODO: parameter for dog in printAnimals method
        		printAnimals(dog);
        	}
        	if (i.equals("5")) {
        		//TODO: parameter for monkey in printAnimals method
        		printAnimals(monkey);
        	}
        	if (i.equals("6")) {
        		//TODO: parameter for available in printAnimals method
	...
	// to make sure the monkey doesn't already exist and the species type is allowed
        public static void intakeNewMonkey(Scanner scanner) {
            ...
            // boolean reserved input with validation
